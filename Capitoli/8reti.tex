...
% ============================================================
\subsection{Dal Biologico all'Artificiale}
% ============================================================
...
\paragraph{How a neuron behaves}
...
\paragraph{Overfitting e Regolarizzazione (Dropout)}

\paragraph{Combatting overfitting in ANNs}
...
\paragraph{Dropout}
Il \textbf{Dropout} consiste nel disattivare (\textit{congelare})
...
L'\textbf{Early Stopping} prevede il monitoraggio delle prestazioni su
