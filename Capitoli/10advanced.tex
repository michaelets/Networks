...
\subsection{Panoramica e Data Augmentation}
...
per sovracampionare la classe minoritaria fino a bilanciare la
distribuzione complessiva.

\paragraph{Variante Borderline SMOTE}
...
\paragraph{Introduzione alle GAN}
...
\subsubsection{Concetti Base ed Esempi Avversari}

\paragraph{Definizione e Rilevanza per la Sicurezza}
...
$P_{B(x_0, \epsilon)}$ sull'``palla'' attorno al punto $x_0$
...
\paragraph{Introduzione al Reinforcement Learning}
...
Il ciclo di apprendimento, come mostrato nello schema, coinvolge
