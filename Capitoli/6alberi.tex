...
struttura dell'albero, partendo dal \textbf{nodo radice}
(\textit{Root Node}) fino a raggiungere un
\textbf{nodo foglia} (\textit{Leaf Node}). In questa
...
% ............................................................
\subsubsection{Esempio di Training Set e Struttura}
% ............................................................

Per comprendere meglio il funzionamento, si consideri un
training set composto da eventi di rete (da E1 a E13)
...
\begin{equation}
    i(N) = -\sum_{j=1}^{H} P(w_j) \log_2 P(w_j)
\end{equation}
...
\begin{equation}
    0.94 -
    \left[\frac{5}{14}\cdot 0.971
    + \frac{4}{14}\cdot 0.0
    + \frac{5}{14}\cdot 0.971\right]
    = 0.246
\end{equation}
...
Confrontando i risultati $(0.246,\ 0.023,\ 0.1515,\ 0.048)$,
...
\begin{itemize}
    ...
    \item $R(T)$ indica gli errori di classificazione
        alle foglie, calcolato sommando su tutte le
        foglie $L$ il prodotto dell'impurezza $i(L)$
        per la proporzione di campioni in quella foglia.
...
\bottomrule
\end{tabular}
\caption{Confronto tra Pre-Pruning e Post-Pruning}
\end{table}
