...
% ===========================================================
\subsection{Limitazioni e Confronto tra Approcci: Rule-Based vs Policy-Based}
% ===========================================================
...
\begin{itemize}
    \item \textbf{Vantaggi}: configurazione lineare e intuitiva.
    \item \textbf{Esempio}: una regola che permette il traffico DNS esclusivamente verso un server esterno noto.
\end{itemize}
...
% -----------------------------------------------------------
\subsubsection{Difficoltà dei Sistemi Rule-Based}
% -----------------------------------------------------------
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/firewall.png}
\end{figure}
...
\begin{enumerate}
    \item \textbf{Posizione 1 (Esterna)}: per rilevare tentativi di attacco diretti prima del firewall.
    \item \textbf{Posizione 2 (DMZ)}: per monitorare il traffico verso i servizi esposti.
    \item \textbf{Posizione 3 (Core Network)}: per proteggere i server critici e i dati sensibili.
    \item \textbf{Posizione 4 (Workstation)}: per identificare minacce interne o traffico laterale tra client.
\end{enumerate}
...
% -----------------------------------------------------------
\subsubsection{Architetture di Attacco}
% -----------------------------------------------------------
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{img/directAttack.png}
    \end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{img/reflectorAttack.png}
    \end{figure}

\end{itemize}

% -----------------------------------------------------------
\subsubsection{Strategie di Difesa}
% -----------------------------------------------------------
